...
export declare class DistanceMeasurementsPlugin extends Plugin {
  ...
  /**
   * Fires when a measurement lifecycle event is happened.
   * @param {String} event The event
   * @param {Function} callback Callback fired on the event
   * @return {String} Handle to the subscription, which may be used to unsubscribe with {@link #off}.
   */
  on(event: "measurementCreated" | "measurementDestroyed" | "measurementEnd", callback: (measurement: DistanceMeasurement)=> void): string;
